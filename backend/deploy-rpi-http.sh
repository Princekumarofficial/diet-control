...
COMPOSE_FILE="docker-compose.rpi.http.yml"
...
echo "[5/6] Starting backend + nginx (HTTP)..."
...
echo
echo "Backend deployed behind Nginx over HTTP."
echo "Open: http://<raspberry-pi-ip>:${HTTP_PORT:-80}/api/v1/dashboard/today/"
